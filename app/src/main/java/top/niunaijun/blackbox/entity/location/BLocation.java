...
public class BLocation implements Parcelable {
    ...
    public Location convert2SystemLocation() {
        Log.i("[sandbox]BLocation", "convert2SystemLocation: lat=" + mLatitude + " lng=" + mLongitude + " alt=" + mAltitude + " spd=" + mSpeed + " bea=" + mBearing);
        ...
        Log.i("[sandbox]BLocation", "convert2SystemLocation: result=(" + location.getLatitude() + "," + location.getLongitude() + ") spd=" + location.getSpeed() + " prov=" + location.getProvider());
        return location;
    }
}
